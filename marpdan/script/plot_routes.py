...
if __name__ == "__main__":
    ...
    chkpt = torch.load(".\output\VRPTWn10m2_230329-1545\chkpt_ep4.pyth", map_location = "cpu")
    ...
    data = VRPTW_Dataset.generate(BATCH_SIZE,10,2)
    
    ref_routes, costs, pens = ort_solve(data)
